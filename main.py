...
while True:
    ...
    if pygame.Rect.colliderect(wall1, squid.rect):
        squid.speed = 2
    elif pygame.Rect.colliderect(wall2, squid.rect):
        squid.speed = 2
    elif pygame.Rect.colliderect(wall3, squid.rect):
        squid.speed = 2
    elif pygame.Rect.colliderect(wall4, squid.rect):
        squid.speed = 2
    else:
        squid.speed = 5

    # eel wall collisions
    if pygame.Rect.colliderect(wall1, eel.rect):
        eel.speed = 2
    elif pygame.Rect.colliderect(wall2, eel.rect):
        eel.speed = 2
    elif pygame.Rect.colliderect(wall3, eel.rect):
        eel.speed = 2
    elif pygame.Rect.colliderect(wall4, eel.rect):
        eel.speed = 2
    else:
        eel.speed = 5
...
while True:
    ...
    clock.tick(40)
>>>>>>> 2c63d3847659303f2bce404fddcdfae775af45a0:SquidVsEel/main.py
